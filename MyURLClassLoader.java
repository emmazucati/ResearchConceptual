    ...
    */
        ...
        MyURLClassLoader ucl = AccessController.doPrivileged(
            new PrivilegedAction<MyURLClassLoader>() {
                public MyURLClassLoader run() {
                    return new FactoryMyURLClassLoader(urls, parent, acc);
                }
            });
        return ucl;
    }
    ...
    public static MyURLClassLoader newInstance(final URL[] urls) {
        ...
        MyURLClassLoader ucl = AccessController.doPrivileged(
            new PrivilegedAction<MyURLClassLoader>() {
                public MyURLClassLoader run() {
                    return new FactoryMyURLClassLoader(urls, acc);
                }
            });
        return ucl;
    }
    ...
    static {
        sun.misc.SharedSecrets.setJavaNetAccess (
            new sun.misc.JavaNetAccess() {
                public URLClassPath getURLClassPath (PluginClassLoader u) {
                    return u.ucp;
                }
...
final class FactoryMyURLClassLoader extends MyURLClassLoader {

    static {
        ClassLoader.registerAsParallelCapable();
    }

    FactoryMyURLClassLoader(URL[] urls, ClassLoader parent,
                          AccessControlContext acc) {
        super(urls, parent, acc);
    }

    FactoryMyURLClassLoader(URL[] urls, AccessControlContext acc) {
        super(urls, acc);
    }
